...
export const CATEGORIES: CategoryDef[] = [
  {
    ...
    emoji: '🤖',
    hex: '#7c3aed',
    appStore: { mode: 'search', searchTerms: ['AI assistant', 'ChatGPT'] },
  ...
  },
  {
    ...
    emoji: '💻',
    hex: '#059669',
    appStore: { mode: 'search', searchTerms: ['code editor', 'developer tools'] },
  ...
  },
  {
    ...
    emoji: '🧠',
    hex: '#f59e0b',
    appStore: { mode: 'search', searchTerms: ['AI agent'] },
